...
#contract1.owner_paypal = contract1.car.owner.paypal.first
#contract1.renter_paypal = user2.paypal.first
#contract1.save!

#contract2 = car7.contracts.new(start_date: '2018-04-07', return_date:'2018-04-08', price: '20', subtotal: '40', total: '40.5', status: 'pending')
#contract2.owner_paypal = contract2.car.owner.paypal.first
#contract2.renter_paypal = user2.paypal.first
#contract2.save!
...
#profile1 = Profile.new(drivers_license: '123456789', first_name: 'Salina', last_name: 'Dutta', middle_name: 'Kumari', backgroundcheck_status: 'checked', phone: '901-875-5522', social_security: 675551122)
#profile2 = Profile.new(drivers_license: '875622212', first_name: 'Anu', last_name: 'Roy', middle_name: 'Kumar', backgroundcheck_status: 'unchecked', phone: '901-255-2525', social_security: 122220222)
#print " welcome"
...
#paypal2 = user1.paypals.new(paypal_id: 82202, paypal_username: 'Senjuti5', paypal_account_routing_number: 22002222)

#print "hello"
#user1.paypal = paypal1
#paypal1.save!
#user1.save!
