...
class Car < ApplicationRecord
    ...
    validates :year, numericality: { only_integer: true, greater_than_or_equal_to: 1900, less_than_or_equal_to: Date.current.year }
    ...
    validates :price_per_day, format: { with: /\A\d{1,4}(.\d{0,2})?\z/ }
end
