...
class CarRatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create car_rating" do
    assert_difference('CarRating.count') do
      post car_ratings_url, params: { car_rating: { rating: @car_rating.rating, comments: @car_rating.comments, car_id: @car_rating.car.id, user_id: @car_rating.user.id, contract_id: @car_rating.contract.id } }
    end
  ...
  test "should update car_rating" do
    patch car_rating_url(@car_rating), params: { car_rating: { rating: @car_rating.rating, comments: @car_rating.comments, car_id: @car_rating.car.id, user_id: @car_rating.user.id, contract_id: @car_rating.contract.id } }
